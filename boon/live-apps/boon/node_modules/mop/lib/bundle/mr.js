...
var MrBootstrap = require("montage/core/mr/bootstrap-node");
...
function loadMrScript(element, file, config) {
    ...
    .then(function (loader) {
        ...
        .then(function (mrPackage) {
            return mrPackage.loadPackage({name: "bluebird"});
        })
        .then(function () {
...
function bundleMrScript(bootstrapBundle, preloadFiles, element, file, config) {
    ...
    element.setAttribute("data-bluebird-location", toPromise);

    element.setAttribute("data-mr-hash", requirePackage.hash);
    element.setAttribute("data-bluebird-hash", promisePackage.hash);
