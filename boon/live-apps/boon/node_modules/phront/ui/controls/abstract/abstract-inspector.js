var AbstractComponentActionDelegate = require("ui/controls/abstract/abstract-component-action-delegate").AbstractComponentActionDelegate,
    ...
    enterDocument: {
        value: function(isFirstTime) {
            ...
            if (_.isFunction(this._handleInspectorExit) && !this.inspectorExitListener) {
                this.inspectorExitListener = this._handleInspectorExit.bind(this);
                this.application.addEventListener('inspectorExit', this.inspectorExitListener);
            }
        }
    },
    ...
    exitDocument: {
        value: function() {
            ...
            if (this.inspectorExitListener) {
                this.application.removeEventListener('inspectorExit', this.inspectorExitListener);
