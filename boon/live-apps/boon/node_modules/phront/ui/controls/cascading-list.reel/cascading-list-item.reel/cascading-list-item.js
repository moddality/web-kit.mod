            ...
            if (this._data !== data) {
                ...
                if (data) {
                    ...
                    if (data.object && ModelEventChange[data.objectType] && _.isFunction(ModelEventChange[data.objectType].remove)) {
                        this._objectDeletedListener = this._handleObjectDeleted.bind(this);
                        this.application.addEventListener(ModelEventChange[data.objectType].remove(data.object.id), this._objectDeletedListener);
                    }
    ...
    _removeObjectDeletedListener: {
        value: function () {
            if (this._objectDeletedListener && this._data && this._data.object && ModelEventChange[this._data.objectType] && _.isFunction(ModelEventChange[this._data.objectType].remove)) {
                this.application.removeEventListener(ModelEventChange[this._data.objectType].remove(this._data.object.id), this._objectDeletedListener);
            }
        }
    },
