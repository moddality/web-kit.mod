...
gulp.task('serve', ['allCss'], function() {
    ...
    gulp.watch(ui/controls/**/**/_*.css", ['css']);
    gulp.watch([ui/controls/_config.css", "ui/_theme.css"], ['allCss']);
    gulp.watch(ui/controls/**/**/*.html").on('change', browserSync.reload);
});

gulp.task('css', function() {

    return gulp.src([ui/controls/**/**/_*.css", "!ui/**/**/_config.css"])
